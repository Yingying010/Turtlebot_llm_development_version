...
if __name__ == "__main__":
    raw_response = dedent("""
    {
      "robots": {
        "robot1": [
          {"action": "move",  "parameters": {"direction": "forward", "value": 1, "unit": "m"}},
          {"action": "turn",  "parameters": {"direction": "left",    "value": 90, "unit": "degrees"}, "sync_group": "G1"},
          {"action": "move",  "parameters": {"direction": "forward", "value": 2, "unit": "m"},        "sequence": 1},
          {"action": "turn",  "parameters": {"direction": "right",   "value": 45, "unit": "degrees"}}
        ],
        "robot2": [
          {"action": "face",  "parameters": {"target": "user"}},
          {"action": "rotate","parameters": {"direction": "right",   "value": 30, "unit": "degrees"}, "sync_group": "G1"},
          {"action": "move",  "parameters": {"direction": "forward", "value": 3, "unit": "m"},        "sequence": 2}
        ]
      }
    }
    """)
