...
bool phasespace_msgs__msg__camera__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("phasespace_msgs.msg._camera.Camera", full_classname_dest, 34) == 0);
  }
  phasespace_msgs__msg__Camera * ros_message = _ros_message;
  {  // id
...
PyObject * phasespace_msgs__msg__camera__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("phasespace_msgs.msg._camera");
