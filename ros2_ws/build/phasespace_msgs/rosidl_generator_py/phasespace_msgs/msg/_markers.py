...
class Markers(metaclass=Metaclass_Markers):
    ...
    _fields_and_field_types = {
        'markers': 'sequence<phasespace_msgs/Marker>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['phasespace_msgs', 'msg'], 'Marker')),  # noqa: E501
    )
