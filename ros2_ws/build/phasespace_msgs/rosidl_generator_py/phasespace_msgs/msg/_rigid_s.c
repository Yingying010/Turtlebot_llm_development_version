...
bool phasespace_msgs__msg__rigid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("phasespace_msgs.msg._rigid.Rigid", full_classname_dest, 32) == 0);
  }
  phasespace_msgs__msg__Rigid * ros_message = _ros_message;
  {  // id
  ...
  {  // heading_y
    ...
    assert(PyFloat_Check(field));
    ros_message->heading_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // cond
...
PyObject * phasespace_msgs__msg__rigid__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("phasespace_msgs.msg._rigid");
