...
#include "phasespace_msgs/msg/detail/rigid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const phasespace_msgs::msg::Rigid & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phasespace_msgs::msg::Rigid & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs::msg::Rigid;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phasespace_msgs::msg::Rigid *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phasespace_msgs::msg::Rigid *>(
    untyped_ros_message);
...
{
  return &phasespace_msgs::msg::typesupport_fastrtps_cpp::_Rigid__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phasespace_msgs, msg, Rigid)() {
  return &phasespace_msgs::msg::typesupport_fastrtps_cpp::_Rigid__handle;
}
