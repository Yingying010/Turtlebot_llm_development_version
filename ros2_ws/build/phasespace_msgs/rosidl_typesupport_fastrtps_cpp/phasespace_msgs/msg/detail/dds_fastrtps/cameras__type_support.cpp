...
#include "phasespace_msgs/msg/detail/cameras__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const phasespace_msgs::msg::Camera &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  phasespace_msgs::msg::Camera &);
  ...
  size_t current_alignment)
{
  ...
  // Member: cameras
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        phasespace_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Camera(
  ...
  if (is_plain) {
    ...
    using DataType = phasespace_msgs::msg::Cameras;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phasespace_msgs::msg::Cameras *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phasespace_msgs::msg::Cameras *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Cameras__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const phasespace_msgs::msg::Cameras *>(
...
static size_t _Cameras__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Cameras(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Cameras__callbacks = {
  "phasespace_msgs::msg",
  "Cameras",
...
static rosidl_message_type_support_t _Cameras__handle = {
...
{
  return &phasespace_msgs::msg::typesupport_fastrtps_cpp::_Cameras__handle;
}
